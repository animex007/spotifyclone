  ...
  const Data = [
    {
      ...
      title: "Metallica",
      description: "Middle age - metallica",
    },
    {
      thumbnail: DummyMusicThumb3,
      title: "smell like teen sprit",
      description: "nirvana|| Episodes",
    },
    {
      thumbnail: DummyMusicThumb4,
      title: "in the end",
      description: "linkin park - hybrid theory",
    },
    {
      thumbnail: DummyMusicThumb1,
      title: "can you feel my heart",
      description: "BMTH - Sempiternal",
    },
    {
      thumbnail: DummyMusicThumb5,
      title: "High",
      description: "chainsmoker - live form drew kicten",
    },
  ];
